        ...
        <Slider {...settings}>
            {reviews.map((review, index) => (
                <div key={index} className="review">
                    <img src={review.image} alt={review.name} style={{ width: 100, height: 100, borderRadius: '50%' }} />
                    <h3>{review.name}</h3>
